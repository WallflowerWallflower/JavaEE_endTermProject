                        ...
                        <div class="limit-box">
                            <nav class="main-menu">
                                <ul class="menu-area-main">
                                    ...
                                    <li><a class="sign" href="LogoutServlet">Logout<%@ page autoFlush = "true" %></a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
...
<!-- Download -->
<div  class="Lastestnews" id="screenshot">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
...
<!-- Albums -->
<div id="screenshot1" class="Albums">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="titlepage">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margin">
                <div class="Albums-box">
                    <figure>
                        ...
                        <span class="hoverle">
                        <a href="images/album1.jpg" class="fancybox" rel="ligthbox"><img src="images/search.png" alt="img"></a>
                        </span>
                    </figure>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 margin">
                <div class="Albums-box">
                    <figure>
                        ...
                        <span class="hoverle">
                        <a href="images/album2.jpg" class="fancybox" rel="ligthbox"><img src="images/search.png" alt="img"></a>
                        </span>
                    </figure>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 width">
                    <div class="address">
                        ...
                        <ul class="locarion_icon">
                            <li><img src="icon/1.png" alt="icon" />12B Abaya  Almaty</li>
                            <li><img src="icon/2.png" alt="icon" />Phone : 700520051</li>
                            <li><img src="icon/3.png" alt="icon" />Email : demo@email.com</li>
                            <li><a href="adminLogin.jsp" style="color: white">Admin</a></li>
                            <li><a href="supAdminLogin.jsp" style="color: white">Super Admin</a></li>
